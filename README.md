The Energy Information Administration Agency (EIA) is a critical source of data in the Energy Industry. Indeed, according to a Citadel Commodities Quant, if one has EIA data, then one should use EIA data. 

For Natural Gas, the analytics/information derivied from EIA data combined/correlated with Weather Data are very important and a core component of a energy's fund investment strategy. 

However, while the discussion and documentation of EIA Data is highly rigorous, the documentation and discussion of the derived analytics is less well documented/discussed/benchmarked. 
